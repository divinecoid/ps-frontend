...
export default function MasterFactories() {
    ...
    return <OverviewPage
        ...
        actions={(props) => [
            canDelete && <DatatableSelectAction {...props} action={Services.MasterCMT.multiDestroy} trigger="Hapus" variant="destructive" title={`Apakah anda yakin untuk menghapus ${props.selectedRows.length} pabrik?`} description={`Aksi ini akan menghilangkan ${props.selectedRows.length} pabrik terpilih dari daftar pilihan.`} />,
